...
# count words in stopwords and numbers which has in the file text
...
def filterWord(word: str):
    if word in stop_words or word in numbers:
        return word
...
if __name__ == "__main__":
    ...
    words = lines.flatMap(lambda line: COMMA_DELIMITER.split(line)) \
        ...
        .collect() \
        #.foreach(lambda iteam: print(iteam))

    #words.saveAsTextFile("hdfs:///tmp/wordcount/spark/task2.3")
